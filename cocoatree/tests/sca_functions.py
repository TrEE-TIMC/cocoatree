...
def compute_sca_matrix(joint_freqs, joint_freqs_ind, fia, qa, graphic=False):
    ...
    graphic : boolean,
            whether to plot the SCA coevolution matrix
    ...
    # To move outside of the function
    if graphic:
        plt.figure()
        plt.rcParams['figure.figsize'] = 9, 8
        plt.imshow(Cij, vmin=0, vmax=1.4, interpolation='none', aspect='equal')
        plt.colorbar(shrink=0.7)
        plt.title("SCA coevolution matrix")
        plt.show()
